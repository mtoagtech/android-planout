...
class VisitorSearchViewAdapter(val activity: Activity?) : RecyclerView.Adapter<VisitorSearchViewAdapter.ViewHolder>() {

    lateinit var layoutManager: LinearLayoutManager
    lateinit var tagsAdapter : TagsViewAdapter

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.row_visitor_search_item_view, parent, false)
